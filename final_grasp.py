...
class Vehicle:
    def __init__(self, capacity, cost, fixed_cost):
        self.capacity = capacity
        self.filled = 0
        self.cost = cost
...
class MultiDepotVRP:
    ...
    def solve(self):
        ...
        for _ in range(self.max_iterations):
            ...
            elif (best_customers_served == final_customers_served and 
...
def read_instance(filename):
    with open(filename, 'r') as file:
        ...
        for vehicle_index in range(num_vehicles):
            ...
            vehicles.append(Vehicle(capacity, cost_per_distance, fixed_cost))
